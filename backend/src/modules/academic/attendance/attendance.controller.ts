...
export class AttendanceController {
  ...
  findAll(
    ...
    return this.service.findAll({ courseId, date, from, to });
  }
  ...
  findByStudent(
    ...
    return this.service.findByStudent(studentId, courseId);
  }

  @Get("stats/:studentId")
  @Roles("TEACHER", "ADMIN", "SUPER_ADMIN", "DIRECTION", "UTP", "STUDENT")
  @ApiOperation({ summary: "Estadísticas de asistencia de un alumno" })
  getStats(@Param("studentId", ParseUUIDPipe) studentId: string) {
    return this.service.getStudentStats(studentId);
  }
